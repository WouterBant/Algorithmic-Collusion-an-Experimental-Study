...
def simulate_episode_DQN(env, Qs, Thetas, gamma=0.9, T=5000, L=100):
    """
    ...
    for t in range(3, T+1):
        ...
        q1.append(current_action1.q); theta1.append(current_action1.theta)
        q2.append(current_action2.q); theta2.append(current_action2.theta)
    return (pi1_ep, pi2_ep, theta1, theta2, q1, q2)
...
def simulate_episodes(groupname, env, Qs, Thetas, gamma, T=10000, L=100, n_episodes=1_000, kappa=1):
    """
    ...
    with h5py.File(file_path, 'a') as file:
        ...
        pi1_t_dataset = group.create_dataset('pi1_t', (n_episodes, 1093), dtype='float')
        pi2_t_dataset = group.create_dataset('pi2_t', (n_episodes, 1093), dtype='float')
        theta1_t_dataset = group.create_dataset('theta1_t', (n_episodes, 1093), dtype='float')
        theta2_t_dataset = group.create_dataset('theta2_t', (n_episodes, 1093), dtype='float')
        q1_t_dataset = group.create_dataset('q1_t', (n_episodes, 1093), dtype='float')
        q2_t_dataset = group.create_dataset('q2_t', (n_episodes, 1093), dtype='float')
        datasets = [pi1_t_dataset, pi2_t_dataset, theta1_t_dataset, theta2_t_dataset, q1_t_dataset, q2_t_dataset]
        ...
        for i in range(n_episodes):
            print(i)
            pi1_t, pi2_t, theta1_t, theta2_t, q1_t, q2_t = simulate_episode_DQN(env, Qs, Thetas, gamma=gamma, T=T)
            # if Qlearning:
            ...
            data = [pi1_t, pi2_t, theta1_t, theta2_t, q1_t, q2_t]
